...
public class MenuTest {
	...
	@Test
	public void send_in_lowercase_choice_and_menu_routine_recognizes_as_valid_input() {
		Object[] options = new Object[] {"(C1)          Cola                           $1.25       (4 in stock)","(C2)          Dr. Salt                           $1.50       (5 in stock)"};
		Menu menu = getMenuForTestingWithUserInput("c1");

		String actual = (String) menu.getChoiceFromOptions(options);
		String expected = "c1";
